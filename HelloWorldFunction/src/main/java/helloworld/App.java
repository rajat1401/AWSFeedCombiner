...
public class App implements RequestHandler<Object, String>{
    ...
    public String handleRequest(final Object input, final Context context){
        ...
        try{
            ...
            for (int i=0; i<num; i++){
                streams.add(client.getObject("rajat-lamda-edge-test", names.get(i)).getObjectContent());
                sizes.add(streams.get(i).available());
            }
            ...
            InputStream test = new S3Iterator(names, sizes, streams, gzip);
            int a= test.read();
            gzip.close();
        ...
        //code for returning cloudfront signed URL, if necessary!
